    ...
    while(choix==1)
    {
        ...
        if(choix==1 && mouse_x>7 && mouse_x<295 && mouse_y>(SCREEN_W/2)+90 && mouse_y<(SCREEN_W/2)+150 && mouse_b&1)
        {
            ...
            while(choix==2)
            {
                ...
                {
                    if(d_vertex==0 && d_edge==0 && mouse_b&2 && mouse_x>g.getSommetTab()[i]->getpos_x()-30 && mouse_x<g.getSommetTab()[i]->getpos_x() && mouse_y>g.getSommetTab()[i]->getpos_y()+25 && mouse_y<g.getSommetTab()[i]->getpos_y()+80)
                    {
                    ...
                    else if(d_vertex==0 && d_edge==0 && mouse_b&1 && mouse_x>g.getSommetTab()[i]->getpos_x()-30 && mouse_x<g.getSommetTab()[i]->getpos_x() && mouse_y>g.getSommetTab()[i]->getpos_y()+25 && mouse_y<g.getSommetTab()[i]->getpos_y()+80)
                    {
                        g.getSommetTab()[i]->setpop(g.getSommetTab()[i]->getpop()+5);
                        for(auto& elem : g.getEdgeTab())
                        {
                    ...
                    else if(d_vertex==0 && d_edge==0 && mouse_b&1 && mouse_x>g.getSommetTab()[i]->getpos_x() && mouse_x<g.getSommetTab()[i]->getpos_x()+TAILLEX && mouse_y>g.getSommetTab()[i]->getpos_y() && mouse_y<g.getSommetTab()[i]->getpos_y()+TAILLEY)
                    {
                        click = 1;
                        mem = i;
                    }
                ...
                for(auto& elem : g.getEdgeTab())
                {
                    if(d_vertex==0 && d_edge==0 && mouse_b&2 && click==0 && mouse_x>(abs(elem.geta().getpos_x()+elem.getb().getpos_x())/2)+15 && mouse_x<(abs(elem.geta().getpos_x()+elem.getb().getpos_x())/2)+45 && mouse_y>(abs(elem.geta().getpos_y()+elem.getb().getpos_y())/2)+10 && mouse_y<(abs(elem.geta().getpos_y()+elem.getb().getpos_y())/2)+30)
                    {
                    ...
                    else if(d_vertex==0 && d_edge==0 && mouse_b&1 && click==0 && mouse_x>(abs(elem.geta().getpos_x()+elem.getb().getpos_x())/2)+15 && mouse_x<(abs(elem.geta().getpos_x()+elem.getb().getpos_x())/2)+45 && mouse_y>(abs(elem.geta().getpos_y()+elem.getb().getpos_y())/2)+10 && mouse_y<(abs(elem.geta().getpos_y()+elem.getb().getpos_y())/2)+30)
                    {
                        if(elem.getWeight()+5>0)
                        {
                            elem.setWeight(elem.getWeight()+5);
                ...
                if(d_vertex==0 && d_edge==0 && click==1)
                {
                    clear_bitmap(buffer);
                    ///MISE A JOUR SOMMET
                ...
                if(d_vertex==0 && d_edge==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>100 && mouse_y<149 && mouse_b&1)
                {
                    rest(200);
                    g.AddVertex();
                ...
                if(d_vertex==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>149 && mouse_y<194 && mouse_b&1)
                {
                    rest(200);
                    d_vertex=1;
                }
                ...
                if(d_vertex==0 && d_edge==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>272 && mouse_y<320 && mouse_b&1)
                {
                    rest(200);
                    g.AddEdge();
                }
                ...
                if(d_edge==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>320 && mouse_y<366 && mouse_b&1)
                {
                    rest(200);
                    d_edge=1;
                }
                ...
                if(d_vertex==0 && d_edge==0 && choix==2 && mouse_x>15 && mouse_x<75 && mouse_y>(SCREEN_H/1.25) && mouse_y<(SCREEN_H/1.25)+60 && mouse_b&1)
                {
                ...
                ///ON CLIQUE SUR EXIT
                if(d_vertex==0 && d_edge==0 && choix==2 && mouse_x>15 && mouse_x<75 && mouse_y>(SCREEN_H/1.1) && mouse_y<(SCREEN_H/1.1)+60 && mouse_b&1)
                {
                    choix=1;
                    rest(200);
                }
