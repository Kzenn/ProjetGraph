...
void Graph::AddEdge()
{
    allegro_message("Entrer les parametres de votre arete");
    int S1 = 0;
    int S2 = 0;
    int poids = 0;
    std::cout << "Veuillez choisir l'indice du premier sommet : " << std::endl;
    std::cin >> S1;
    while(S1 >= vecSommet.size())
    {
        std::cout << "Veuillez choisir un indice correct pour le premier sommet : " << std::endl;
        std::cin >> S1;
    }

    std::cout << "Veuillez choisir l'indice du deuxieme sommet : " << std::endl;
    std::cin >> S2;
    while(S2 >= vecSommet.size())
    {
        std::cout << "Veuillez choisir un indice correct pour le deuxieme sommet : " << std::endl;
        std::cin >> S2;
    }

    std::cout << "Veuillez choisir le poids de votre arete : " << std::endl;
    std::cin >> poids;
    if(poids < 0)
    {
        poids = 0;
    ...
    Edge *ve = new Edge(vecSommet[S1],vecSommet[S2],poids,false);
    EdgeTab.push_back(*ve);
    allegro_message("Votre arete est ajoutee");
}
