...
public :
    ...
    std::vector<std::vector<int>>toutesLesComposantesFortementConnexes(std::vector<std::vector<int>> adjacence, int ordre);
    std::vector<int>uneComposanteFortementConnexe(std::vector<std::vector<int>> adjacence, int ordre, int s);
