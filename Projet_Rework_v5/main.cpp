...
int main()
{
    ...
    while(choix==1)
    {
        ...
        if(choix==1 && mouse_x>7 && mouse_x<295 && mouse_y>(SCREEN_W/2) && mouse_y<(SCREEN_W/2)+60 && mouse_b&1)
        {
            ...
            g.ClearVecSommet();
            choice = g.CreateFile();
            std::cout << "nom du fichier " << choice << std::endl;
            allegro_message("lol");
            while(choix==2)
            {
                if(key[KEY_ESC])
                ...
                if(d_vertex==0 && d_edge==0 && a_edge==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>100 && mouse_y<149 && mouse_b&1)
                {
                    rest(200);
                    g.AddVertex();
                ...
                if(d_vertex==0 && d_edge==0 && a_edge==0 && choix==2 && mouse_x>30 && mouse_x<60 && mouse_y>272 && mouse_y<320 && mouse_b&1)
                {
                    rest(200);
                    a_edge=1;
                ...
                if(d_vertex==0 && d_edge==0 && a_edge==0 && choix==2 && mouse_x>15 && mouse_x<75 && mouse_y>(SCREEN_H/1.25) && mouse_y<(SCREEN_H/1.25)+60 && mouse_b&1)
                {
                    g.SaveFile(choice);
                ...
                ///ON CLIQUE SUR EXIT
                if(g.getEdgeTab().size()!=0 && g.getSommetTab().size()!=0 && d_vertex==0 && d_edge==0 && a_edge==0 && choix==2 && mouse_x>15 && mouse_x<75 && mouse_y>(SCREEN_H/1.1) && mouse_y<(SCREEN_H/1.1)+60 && mouse_b&1)
                {
                    choix=1;
                    rest(200);
                }
